...
func main() {
	...
	fmt.Println(now.Format("2006/01/02 15/03/04"))        //2020/08/29 13/01/06
	fmt.Println(now.Format("2006/01/02 15/03/04 PM"))     //2020/08/29 13/01/06 PM
	fmt.Println(now.Format("2006/01/02 15/03/04.000 PM")) //2020/08/29 13/01/08.909 PM
	//go语言中按照对应格式，解析字符串时间
